...
* Bug: omp barrier is only called by 2 threads the picks up the work in sections 
       and not called by others. By removing that barrier everything works just fine.
******************************************************************************/
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
